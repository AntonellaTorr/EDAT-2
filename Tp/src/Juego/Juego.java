...
public class Juego {
    ...
    public static void trabajarInfoHabitaciones(StringTokenizer st, TablaDeBusqueda infoH, Grafo g) {
        /*Este metodo agrega una habitacion y si hubo exito lo agrega al archivo de log*/
    ...
    public static void trabajarInfoDesafios(StringTokenizer st, TablaDeBusqueda desafios) {
        /*Este metodo agrega un desafio y si hubo exito lo agrega al archivo de log*/
        String cod = st.nextToken();
    ...
    public static void trabajarInfoEquipos(StringTokenizer st, TDB equipos, TablaDeBusqueda infoH) {
         /*Este metodo agrega un equipo y si hubo exito lo agrega al archivo de log*/
        String cod = st.nextToken();
    ...
    public static void trabajarInfoPuertas(StringTokenizer st, TablaDeBusqueda infoH, Grafo g) {
         /*Este metodo agrega una puerta y si hubo exito lo agrega al archivo de log*/
        String cod = st.nextToken();
    ...
    public static char menuABMHabitaciones() {
        /*muestra el menu de altas, bajas y modificaciones de habitaciones y retorna la opcion elegida*/
    ...
    public static void administrarCreacionHabitacion(Grafo plano, TablaDeBusqueda infoH) {
        /*este metodo administra la creacion de una habtacion, muestra mensaje de error si la habitacion ya existe*/
    ...
    public static void administrarEliminacionHabitacion(Grafo plano, TablaDeBusqueda infoH) {
        /*este metodo administra el proceso de eliminacion de una habitacion, muestra un mensaje de error si la habitacion no existe
        ...
        */
        ...
        if (hEliminar != null) {
            //si no hay equipos ocupandola se elimina
    ...
    public static void administrarModificacionesHabitaciones(Grafo plano, TablaDeBusqueda infoH) {
        /*este metodo administra las modificaciones de una habitacion, muestra un mensaje de error si esta no existe*/
    ...
    public static char menuModificacionesHabitaciones() {
        /*muestra el menu de modificaciones de habitaciones y retorna la opcion elegida*/
    ...
    public static char menuABMDesafios() {
         /*muestra el menu de altas, bajas y modificaciones de desafios y retorna la opcion elegida*/
    ...
    public static void administrarCreacionDesafio(TablaDeBusqueda infoD) {
        /*este metodo administra la creacion de un desafio, muestra el mensaje de error si este ya existe*/
    ...
    public static void administrarEliminacionDesafio(TablaDeBusqueda infoD) {
        /*este metodo administra la eliminaciono de un desafio, muestra un mensaje de error si el desafio no existe*/
    ...
    public static boolean eliminarDesafio(TablaDeBusqueda infoD, int n) {
        /*este metodo elimina un desafio y registra su eliminacion*/
    ...
    public static void administrarModificacionesDesafios(TablaDeBusqueda infoD) {
        /*este metodo administra las modificaciones de desafios, si el desafio no existe muestra mensaje de error*/
    ...
    public static char menuModificacionesDesafios() {
        /*muestra el menu de modificaciones de desafios y retorna la opcion elegida*/
        System.out.println("Ingrese N- si desea modificar el nombre");
    ...
    public static void modificarNombreDesafio(Desafio d) {
        /*este metodo modifica el nombre de un desafio*/
        System.out.println("Ingrese el nuevo nombre");
        String res = TecladoIn.readLine();
        d.setNombre(res);
    ...
    public static void modificarTipoDesafio(Desafio d) {
        /*este metodo modifica el tipo de un desafio*/
    ...
    public static char menuABMEquipos() {
        /*muestra el menu de altas, bajas y modificaciones de equipos y retorna la opcion elegida*/
    ...
    public static void administrarCreacionEquipo(TDB infoE, TablaDeBusqueda infoH) {
        /*este metodo administra la creacion de un equipo muestra mensaje de error si los datos ingresados son incorrectos*/
    ...
    public static boolean crearEquipo(TDB infoE, TablaDeBusqueda infoH) {
        ...
        boolean encontrado = infoE.existeClave(nombre), exito = false;
        if (!encontrado) {
            int habitacionAct;
            int puntaje;
    ...
    public static void administrarEliminacionEquipo(TDB infoE, TablaDeBusqueda infoH) {
        //este metodo administra la eliminacion de un equipo
    ...
    public static void administrarAdicionDesafioResuelto(Equipo e, TablaDeBusqueda infoD, MapeoAMuchos desafiosR) {
        /*este metodo administra la adicion de un desafio resuelto si el equipo ingresado no existe muestra mensajes de eror*/
        if (e.getHabitacionActual() != 0) {
    ...
    public static char menuABMPuertas() {
        /*muestra menu de altas, bajas y modificaciones de puertes y retorna la opcion seleccionada*/
    ...
    public static void administrarCreacionPuerta(Habitacion origen, Habitacion destino, Grafo plano) {
        /*este metodo administra la creacion de una puerta si alguna de las habitaciones no existe retorna mensaje de error*/
    ...
    public static void administrarEliminacionPuerta(Habitacion origen, Habitacion destino, Grafo plano) {
        /*este metodo administra la eliminacion de una puerta, si alguna de las habitaciones no existe muestra mensaje de error*/
        if (origen != null && destino != null) {
    ...
    public static void eliminarHabitacion(Grafo plano, Habitacion habO, Habitacion habD) {
        /*se elimina una habitacion, si hubo exito entonces se registra la eliminacion en el archivo de log*/
    ...
    public static void administrarModificacionPuerta(Habitacion origen, Habitacion destino, Grafo plano) {
        /*este metodo administra la modificacion del puntaje de las puertas
        devuelve error si alguna de las habitaciones no existen */
        if (origen != null && destino != null) {
    ...
    public static void modificacionPuntaje(Grafo plano, Habitacion habO, Habitacion habD) {
        /*este metodo trabaja para modificar el puntaje para pasar de habO a habD
        si hay exito entonces registra la modificacion en el archivo de log*/
        System.out.println("Ingrese el nuevo puntaje");
        int nro = TecladoIn.readLineInt();
    ...
    public static void administrarConsultaEsPosibleLlegar(Grafo plano, Habitacion h, TablaDeBusqueda infoH) {
        /*este metodo administra la consulta: es posible llegar
        si la habitacion a la que desea llegar no existe muestra mensaje de error
        */
    ...
    public static void administrarConsultaFormasDePasar(Habitacion h, TablaDeBusqueda infoH, Grafo plano) {
         /*este metodo administra la consulta:formas de pasar
        si la habitacion a la que desea llegar no existe o si la habitacion 3 no existe muestra 
        mensaje de error
        */
        Habitacion h2 = obtenerHabitacion(infoH);
    ...
    public static int menuConsultasDesafios() {
        /*muestra menu consultas de desafios retorna la opcion seleccionada*/
        System.out.println("Ingrese que desea hacer");
    ...
    public static int consultasRegularesEquipo() {
        /*muestra menu de consultas de equipo retorna la opcion seleccionada*/
    ...
    public static void ejecucionJuegoDesafio(TablaDeBusqueda infoD, MapeoAMuchos desafiosR, Equipo e) {
        /*este metodo administra el juego de un desafio, muestra mensaje de error si el desafio no existe o 
        si el equipo ya jugo el desafio
        */
        Desafio d = obtenerDesafio(infoD);
        if (d != null) {
    ...
    public static void ejecucionConsultaSePuedePasar(MapeoAMuchos puertasCompletadas, Equipo e, Grafo plano, TablaDeBusqueda infoH) {
        /*este metodo administra la consulta: se puede pasar, muestra mensaje de error en csao de que la habitacion h2 no exista*/
        Habitacion h2 = obtenerHabitacion(infoH);
        if (h2 != null) {
